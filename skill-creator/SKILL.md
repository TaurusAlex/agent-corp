...
- **description**: When to trigger, what it does. Include both what the skill does AND specific contexts for when to use it. Make descriptions slightly "pushy" to combat undertriggering.
...
1. Spawn subagents with skill AND baseline in the same turn
2. Draft assertions while runs are in progress
3. Capture timing data when runs complete
4. Grade and aggregate results
5. Launch the viewer for user feedback

## Improving the skill

1. Generalize from feedback - don't overfit to examples
